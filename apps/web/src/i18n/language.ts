...
export const translations: Record<Lang, Record<string, string>> = {
  he: {
    ...
    "whatsapp.description": "שליחה וקבלה של הודעות WhatsApp אמיתיות דרך WhatsApp Business Platform של Meta.",
    "whatsapp.prerequisite": "כדי שזה יעבוד באמת, צריך חשבון WhatsApp Business API משלכם דרך Meta (מספר טלפון עסקי מאומת + טוקן גישה). Forge AI לא יכול ליצור את זה במקומכם - זו דרישה של מטא.",
    "whatsapp.phoneNumberId": "מזהה מספר טלפון (Phone Number ID)",
    "whatsapp.phoneNumberId.placeholder": "לדוגמה: 123456789012345",
    "whatsapp.accessToken": "טוקן גישה (Access Token)",
    "whatsapp.accessToken.placeholder": "הדביקו כאן את הטוקן מ-Meta",
    "whatsapp.accessToken.keepHint": "השאירו ריק כדי לשמור על הטוקן הקיים",
    "whatsapp.saving": "שומר…",
    "whatsapp.save": "שמירת הגדרות",
    "whatsapp.saved": "ההגדרות נשמרו.",
    "whatsapp.webhook.heading": "חיבור Webhook",
    "whatsapp.webhook.description": "הדביקו את הכתובת והטוקן האלה בהגדרות ה-Webhook בקונסולת המפתחים של Meta (WhatsApp > Configuration).",
    "whatsapp.webhook.urlLabel": "כתובת Webhook",
    "whatsapp.webhook.copy": "העתקה",
    "whatsapp.webhook.verifyTokenLabel": "Verify Token",
  ...
  en: {
    ...
    "whatsapp.description": "Send and receive real WhatsApp messages through Meta's WhatsApp Business Platform.",
    "whatsapp.prerequisite": "For this to actually work, you need your own WhatsApp Business API account through Meta (a verified business phone number + access token). Forge AI can't create this for you — it's Meta's own requirement.",
    "whatsapp.phoneNumberId": "Phone Number ID",
    "whatsapp.phoneNumberId.placeholder": "e.g. 123456789012345",
    "whatsapp.accessToken": "Access Token",
    "whatsapp.accessToken.placeholder": "Paste your token from Meta here",
    "whatsapp.accessToken.keepHint": "Leave blank to keep the current token",
    "whatsapp.saving": "Saving…",
    "whatsapp.save": "Save Settings",
    "whatsapp.saved": "Settings saved.",
    "whatsapp.webhook.heading": "Webhook Connection",
    "whatsapp.webhook.description": "Paste this URL and token into the Webhook settings in Meta's developer console (WhatsApp > Configuration).",
    "whatsapp.webhook.urlLabel": "Webhook URL",
    "whatsapp.webhook.copy": "Copy",
    "whatsapp.webhook.verifyTokenLabel": "Verify Token",
