...
export const translations: Record<Lang, Record<string, string>> = {
  he: {
    ...
    "topbar.goHome": "חזרה לפרויקטים שלך",
    ...
    "password.show": "הצג סיסמה",
    "password.hide": "הסתר סיסמה",
    ...
    "home.myProjects.sort.recent": "🕐 החדשים ביותר",
    "home.myProjects.sort.alphabetical": "🔤 א-ת",
    ...
    "spec.roles.remove": "זה לא רלוונטי — הסר",
    "spec.roles.lastOneHint": "חייב להישאר תפקיד אחד לפחות",
    "spec.roles.addPlaceholder": "הוסיפו תפקיד שחסר...",
    "spec.roles.add": "הוסף",
    "spec.entities.heading": "המסכים שנבנה",
    "spec.entities.requiredHint": "* שדה חובה",
    "spec.assumptions.heading": "הנחות שעשינו",
    "spec.assumptions.remove": "ההנחה הזו שגויה — הסר",
    "spec.assumptions.addPlaceholder": "הוסיפו הנחה שחסרה...",
    "spec.assumptions.add": "הוסף",
    ...
    "whatsapp.log.filter.label": "סינון לפי סוג הודעה",
    "whatsapp.log.filter.all": "כל ההודעות",
    "whatsapp.log.filter.incoming": "נכנסות בלבד",
    "whatsapp.log.filter.outgoing": "יוצאות בלבד",
    "whatsapp.log.filter.failed": "נכשלו בלבד",
    ...
    "preview.shortcuts": "⌨️ קיצורי מקלדת",
    "shortcuts.title": "⌨️ קיצורי מקלדת",
    "shortcuts.search": "פתיחת חיפוש בכל האפליקציה",
    "shortcuts.help": "הצגת רשימת קיצורי המקלדת הזו",
    "shortcuts.close": "סגירת החלון הפתוח",
    "shortcuts.rowDown": "מעבר לרשומה הבאה בטבלה",
    "shortcuts.rowUp": "מעבר לרשומה הקודמת בטבלה",
    "shortcuts.rowEdit": "עריכת הרשומה המסומנת בטבלה",
    ...
    "preview.refineHistory.search.placeholder": "🔍 חיפוש בהיסטוריית השיפורים…",
    "preview.refineHistory.search.noResults": "אין שיפורים תואמים לחיפוש.",
    ...
    "entity.sort.multiHint": "טיפ: Shift+לחיצה על כותרת עמודה נוספת ממיינת גם לפיה, כשוברת שוויון",
    ...
    "entity.confirmDelete": "למחוק את \"{label}\"? ניתן לבטל למשך כמה שניות אחרי המחיקה.",
    "entity.delete.undoToast": "\"{label}\" נמחק.",
    "entity.delete.undo": "בטל מחיקה",
    ...
    "history.filter.label": "סינון לפי סוג נקודת שמירה",
    "history.filter.all": "הכל",
    "history.filter.build": "בנייה ראשונית",
    "history.filter.refine": "שיפורים בלבד",
    ...
    "history.diff.compareWith": "השוואה מול:",
    "history.diff.currentState": "המצב הנוכחי של האפליקציה",
    "history.diff.comparingTo": "בהשוואה אל: {label}",
    ...
    "collab.loading": "טוען…",
    "collab.owner": "בעל/ת הפרויקט",
    "collab.owner.you": "בעל/ת הפרויקט (את/ה)",
    ...
    "search.recent.heading": "חיפושים אחרונים",
    "search.recent.clear": "ניקוי",
  ...
  en: {
    ...
    "topbar.goHome": "Back to your projects",
    ...
    "home.myProjects.sort.recent": "🕐 Newest first",
    "home.myProjects.sort.alphabetical": "🔤 A–Z",
    ...
    "spec.roles.remove": "Not relevant — remove",
    "spec.roles.lastOneHint": "At least one role must remain",
    "spec.roles.addPlaceholder": "Add a missing role...",
    "spec.roles.add": "Add",
    ...
    "spec.assumptions.remove": "This assumption is wrong — remove",
    "spec.assumptions.addPlaceholder": "Add a missing assumption...",
    "spec.assumptions.add": "Add",
    ...
    "whatsapp.log.filter.label": "Filter by message type",
    "whatsapp.log.filter.all": "All messages",
    "whatsapp.log.filter.incoming": "Incoming only",
    "whatsapp.log.filter.outgoing": "Outgoing only",
    "whatsapp.log.filter.failed": "Failed only",
    ...
    "preview.shortcuts": "⌨️ Keyboard shortcuts",
    "shortcuts.title": "⌨️ Keyboard shortcuts",
    "shortcuts.search": "Open search across the whole app",
    "shortcuts.help": "Show this shortcuts list",
    "shortcuts.close": "Close the open panel",
    "shortcuts.rowDown": "Move to the next table row",
    "shortcuts.rowUp": "Move to the previous table row",
    "shortcuts.rowEdit": "Edit the focused table row",
    ...
    "preview.refineHistory.search.placeholder": "🔍 Search improvement history…",
    "preview.refineHistory.search.noResults": "No improvements match your search.",
    ...
    "entity.sort.multiHint": "Tip: Shift+click another column header to sort by it too, as a tiebreaker",
    ...
    "entity.confirmDelete": "Delete \"{label}\"? You can undo this for a few seconds after.",
    "entity.delete.undoToast": "\"{label}\" deleted.",
    "entity.delete.undo": "Undo",
    ...
    "history.filter.label": "Filter by checkpoint type",
    "history.filter.all": "All",
    "history.filter.build": "Initial build",
    "history.filter.refine": "Refines only",
    ...
    "history.diff.compareWith": "Compare with:",
    "history.diff.currentState": "Current app state",
    "history.diff.comparingTo": "Comparing to: {label}",
    ...
    "collab.owner": "Project owner",
    "collab.owner.you": "Project owner (You)",
    ...
    "search.recent.heading": "Recent searches",
